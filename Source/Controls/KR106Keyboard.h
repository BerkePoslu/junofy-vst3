...
public:
    ...
    void mouseDown(const juce::MouseEvent& e) override
    {
        ...
        // Always play notes from the on-screen keyboard. The Juno "Transpose" switch
        // (kTranspose) is for external MIDI only — when it is on, the processor routes
        // MIDI note presses to transpose offset instead of NoteOn; mouse clicks here
        // would otherwise never call sendNoteOn() and the UI appears silent.
